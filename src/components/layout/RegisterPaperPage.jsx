...
const RegisterPaperPage = () => {
  ...
  return (
    <div
      className="min-h-screen flex flex-col bg-gradient-to-b from-black via-[#00111f] to-black text-white font-orbitron"
    ...
    >
      ...
      <div className="flex-grow flex flex-col items-center justify-center px-4">
        <div className="mt-10 bg-black/60 border border-cyan-400 rounded-2xl shadow-[0_0_20px_#00eaff] p-8 w-[90%] max-w-lg backdrop-blur-md">
