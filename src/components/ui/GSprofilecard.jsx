...
const GSProfileCard = ({ name, designation, phone, linkedin, image }) => {
    ...
    >
      ...
      >
        ...
        <div className="h-2/3 overflow-hidden relative z-20">
          <div
            className={`
              w-60 h-48 bg-cover bg-center justify-center absolute top-5 left-10
              transition-all duration-500
              ${isHovered ? "scale-110 pl-5 pt-4" : "scale-100"}
            `}
        ...
        <div className="h-1/3 p-1 space-y-2 relative z-10 text-center flex flex-col justify-center bg-transparent">
          <h3 className="text-2xl font-nasal font-bold text-[#00f7ff] drop-shadow-[0_0_10px_rgba(0,247,255,0.8)]">
            {name}
          </h3>
          <h4 className="text-lg font-orbitron text-yellow-400">
            {designation}
          </h4>
          <div className="flex items-center justify-center pt-2 pb-8 space-x-4 mt-2">
