...
const ProfileCard = ({ name, phoneNo, linkedin, phone, image }) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="h-2/3 overflow-hidden rounded-t-[1rem] relative z-20">
          <div
            className={`
        ...
        <div className="h-1/3 p-3 space-y-3 relative z-10 text-center flex flex-col justify-center bg-transparent">
